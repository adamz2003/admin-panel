...
import {
  ...
  import { MngPenaltyListData, userList } from "@/utils/fakeDatas";
  ...
  import { PenaltyListColumns, UserColumns } from "@/utils/columns";
  ...
  export const PenaltyListComponent = () => {
    ...
    return (
      <div className="grid gap-8">
        ...
        <CustomizedTable
          data={MngPenaltyListData}
          columns={PenaltyListColumns}
