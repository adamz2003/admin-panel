import {
  ...
  import { HomeBannerListData, userList } from "@/utils/fakeDatas";
  ...
  import { HomeBannerColumns, UserColumns } from "@/utils/columns";
  ...
  export const HomeBannerListComponent = () => {
    ...
    return (
      <div className="grid gap-8">
        ...
        <CustomizedTable
          data={HomeBannerListData}
          columns={HomeBannerColumns}
