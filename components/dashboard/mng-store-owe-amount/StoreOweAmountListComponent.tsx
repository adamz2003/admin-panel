...
import { MngStoreOweAmountListData, userList } from "@/utils/fakeDatas";
...
import { StoreOweAmountListColumns, UserColumns } from "@/utils/columns";
...
export const StoreOweAmountListComponent = () => {
  ...
  return (
    <div className="grid gap-8">
      ...
      <CustomizedTable
        data={MngStoreOweAmountListData}
        columns={StoreOweAmountListColumns}
