...
import { MngStorePayoutListData, userList } from "@/utils/fakeDatas";
...
import { StorePayoutListColumns, UserColumns } from "@/utils/columns";
...
export const StorePayoutListComponent = () => {
  ...
  return (
    <div className="grid gap-8">
      ...
      <CustomizedTable
        data={MngStorePayoutListData}
        columns={StorePayoutListColumns}
