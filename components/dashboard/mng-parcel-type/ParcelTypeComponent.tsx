import {
  ...
  import { PacelTypeListData, userList } from "@/utils/fakeDatas";
  ...
  import { ParcelTypeColumns, UserColumns } from "@/utils/columns";
  ...
  export const ParcelTypeComponent = () => {
    ...
    return (
      <div className="grid gap-8">
        ...
        <CustomizedTable
          data={PacelTypeListData}
          columns={ParcelTypeColumns}
