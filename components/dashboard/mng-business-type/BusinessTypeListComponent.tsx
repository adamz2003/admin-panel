import {
  ...
  import { BusinessTypeListData, userList } from "@/utils/fakeDatas";
  ...
  import { BusinessTypeColumns, UserColumns } from "@/utils/columns";
  ...
  export const BusinessTypeListComponent = () => {
