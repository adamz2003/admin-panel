  ...
  return (
    <Card
      ...
      className={
        ...
        "w-full max-w-[16rem] py-4 shadow-xl shadow-blue-gray-900/5 rounded-none flex-grow-0 flex-shrink-0 flex-auto overflow-y-auto overflow-x-hidden " +
        (show
          ? "ease-in-left transition ease-out duration-100"
          : "hidden translate") +
        " " +
        (openNav ? "max-h-[calc(100vh-3.8rem)]" : "fixed top-0 left-0 z-20")
      }
    >
      <List>
        {!openNav ? (
        ...
        <div className="max-h-[calc(100vh-3.8rem)]">
